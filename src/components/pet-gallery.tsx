...
export function PetGallery({ pets }: PetGalleryProps) {
  ...
  return (
    <section className="flex flex-col gap-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        ...
        <label className="relative block w-full lg:max-w-sm">
          ...
          <input
            ...
            className="h-12 w-full rounded-full border border-black/10 bg-white pr-10 pl-12 text-sm text-stone-900 outline-none transition placeholder:text-stone-400 focus:border-black/40"
          />
          {query.length > 0 ? (
            <button
              type="button"
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-black/[0.08] bg-white/55 px-4 py-4 backdrop-blur md:px-5">
        <FilterGroup
          label="Kind"
          options={PET_KINDS}
          counts={kindCounts}
